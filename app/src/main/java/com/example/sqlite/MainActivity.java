...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    View dialogView;
    TextView Tv_Nim, Tv_Nama, Tv_Prodi, Tv_Kelas;
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case 0:
                        ...
                        Tv_Nim = (TextView)dialogView.findViewById(R.id.tv_Nim);
                        Tv_Nama = (TextView)dialogView.findViewById(R.id.tv_Nama);
                        Tv_Prodi = (TextView)dialogView.findViewById(R.id.tv_Prodi);
                        Tv_Kelas = (TextView)dialogView.findViewById(R.id.tv_Kelas);

                        Tv_Nim.setText("Nomor: " + cur.getString(cur.getColumnIndex(DBHelper.row_nim)));
                        Tv_Nama.setText("Nama: " + cur.getString(cur.getColumnIndex(DBHelper.row_nama)));
                        Tv_Prodi.setText("Jenis Kelamin: " + cur.getString(cur.getColumnIndex(DBHelper.row_prodi)));
                        Tv_Kelas.setText("Alamat: " + cur.getString(cur.getColumnIndex(DBHelper.row_kelas)));
