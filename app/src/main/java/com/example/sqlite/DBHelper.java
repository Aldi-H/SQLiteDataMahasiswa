...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String database_name = "dbMahasiswa";
    public static final String table_name = "tabelMahasiswa";

    public static final String row_id = "_id";
    public static final String row_nim = "Nim";
    public static final String row_nama = "Nama";
    public static final String row_prodi = "Prodi";
    public static final String row_kelas = "Kelas";
    ...
    public void onCreate(SQLiteDatabase db) {
        String query = "CREATE TABLE " + table_name + "(" + row_id + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + row_nim + " TEXT, " + row_nama + " TEXT, " + row_prodi + " TEXT, "
                + row_kelas + " TEXT)";
        db.execSQL(query);
    }
